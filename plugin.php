...
try
  {  
				...
				<?php /*CHECK OTHER PLUGNS*/ require_once("utils/other_plugins.php"); ?>
		...
		?>				
		<?php } else{
			require_once("utils/admin_filters.php");								
 } //end of apply for any user except admin ?>	
...
jQuery('#ag_add_adminmenu').append(buttonsJq); 
		...
		<?php  
			...
			if($this->is_agca_page){
				require_once("utils/agca_page.php");
			} 
		?>
 ...
 /* ]]> */ 
	...
	?>	
        ...
        /* <![CDATA[ */
            jQuery(document).ready(function() {			
				try{ 
				<?php require_once("utils/login_filters.php"); ?>			
			 }catch(err){	
